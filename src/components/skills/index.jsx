            ...
            <div className="skills-content-wrapper">
                ...
                <div className="right-col">
                    ...
                    <p>
                        ...
                        development using <span style={{fontWeight : "bolder", fontSize : "20px", textDecoration : "underline"}}>Node.js</span> and <span style={{fontWeight : "bolder", fontSize : "20px", textDecoration : "underline"}}>Express.js</span>, and I also excel in 
                        <span style={{fontWeight : "bolder", fontSize : "20px", textDecoration : "underline"}}>DSA</span> with <span style={{fontWeight : "bolder", fontSize : "20px", textDecoration : "underline"}}>Java</span>, with a strong grasp of 
